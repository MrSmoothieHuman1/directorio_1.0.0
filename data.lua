local function double_hide(prototype)
	prototype.hidden = true
	prototype.hidden_in_factoriopedia = true
end

double_hide(data.raw["recipe"]["iron-plate"])
double_hide(data.raw["recipe"]["copper-plate"])
double_hide(data.raw["recipe"]["steel-plate"])
double_hide(data.raw["recipe"]["iron-gear-wheel"])
double_hide(data.raw["recipe"]["iron-stick"])
double_hide(data.raw["recipe"]["copper-cable"])
double_hide(data.raw["recipe"]["lubricant"])
double_hide(data.raw["recipe"]["stone-brick"])
